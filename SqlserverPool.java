...
public class ReactiveDualPoolExample {
    ...
    private static final UserService service = new UserService(writeDs, readDs);
    ...
    static HikariDataSource createDataSource(String jdbcUrl, boolean readOnly) {
        ...
        config.setDataSource(new DataSource() {
            ...
            public Connection getConnection(String u, String p) throws SQLException {
                ...
                conn.setReadOnly(readOnly); // enforce read-only at driver level
                return conn;
            }
        ...
        config.setMaximumPoolSize(readOnly ? 15 : 10); // more reads
    ...
    static class UserRepository {
        ...
        private final HikariDataSource writeDs;
        private final HikariDataSource readDs;

        UserRepository(HikariDataSource writeDs, HikariDataSource readDs) {
            this.writeDs = writeDs;
            this.readDs = readDs;
        }

        // WRITE (transaction-safe)
    ...
    static class UserService {
        ...
        UserService(HikariDataSource writeDs, HikariDataSource readDs) {
            this.repo = new UserRepository(writeDs, readDs);
        }

        // WRITE (transactional pool)
